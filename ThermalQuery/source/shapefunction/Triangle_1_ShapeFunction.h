//
// 文件名:     Triangle_1_ShapeFunction.h
...
#ifndef included_fem_Triangle_1_ShapeFunction
#define included_fem_Triangle_1_ShapeFunction
...
class Triangle_1_ShapeFunction : public BaseShapeFunction<NDIM> {
public:
  /**
   * @brief 构造函数。
   *
   */
  Triangle_1_ShapeFunction(const string& name);

  /**
   * @brief 析构函数。
   */
  ~Triangle_1_ShapeFunction();
