//
// 文件名:     TwoOrderPatchStrategy.h
// 软件包:     JAUMIN
// 版权　:     北京应用物理与计算数学研究所
// 版本号:     $Revision: 0 $
// 修改　:     $Date: Tue May 20 08:45:12 2014 $
// 描述　:     网格片策略类派生类,支撑二次元的网格片算法.
// 类别　:     %Internal File% ( Don't delete this line )
//

#ifndef included_TwoOrderPatchStrategy
#define included_TwoOrderPatchStrategy
...
class TwoOrderPatchStrategy : public PatchStrategy {
public:
  /*!
   * @brief 构造函数.
   *
   ...
   *
   */
  TwoOrderPatchStrategy(const string& object_name, bool is_from_restart,
                        tbox::Pointer<tbox::Database> input_db);

  /*!
   * @brief 析构函数.
   */
  virtual ~TwoOrderPatchStrategy();
